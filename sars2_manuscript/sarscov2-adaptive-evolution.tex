...
\begin{figure}[h!]
	...
	The phylogeny is divided into overlapping 2-month windows between January 1, 2020 and May 15, 2021.
	For every internal branch within a window, the accumulation of nonsynonymous and synonymous divergence from the root sequence is then calculated. 
	\textbf{A)} Branches used to calculate divergence for the April 1, 2020 (March 1 to April 30) and January 1, 2021 (December 1 to January 31) time windows.
	...
	The ratio of nonsynonymous to synonymous is calculated for various coding regions within the genome. 
	\textbf{B)} Each point shows the mean and 95\% confidence interval of this ratio for all internal branches present in a 2-month window (centered at the date indicated on the x-axis).
	}
	\label{fig:dnds}
\end{figure}
...
For SARS-CoV-2, the time windows were 2 months and the code to run this analysis and reproduce Figure \ref{fig:dnds} is at \texttt{fig2-divergence.ipynb}.
