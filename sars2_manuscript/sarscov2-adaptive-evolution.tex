...
For example, the common ancestor of globally circulating SARS-CoV-2 viruses is currently no earlier than January 2020, corresponding to the base of clade 20A or lineage B.1 \cite{Hadfield2018-wr}.
...
Mutations within other regions of the genome, including spike S2 and nucleocapsid (N), also accumulate at reasonably-high levels, but only Nsp6 and ORF7a mutations have a significant relationship with growth rates at the $p=0.01$ level (Table \ref{tab:table1}, Figures \ref{fig:4_comprehensive} and \ref{fig:mutaccummoregenes}).
...
Removing Delta clades from the analysis drops the $r$ for ORF7a from 0.43 to 0.09, whereas $r$ for S1 only dips from 0.46 to 0.41.
